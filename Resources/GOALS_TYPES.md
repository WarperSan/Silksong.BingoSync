...
- Cragglite Journal Entry
- Gromling Journal Entry
- Mite Mother Journal Entry
- Massive Mossgrub Journal Entry
...
- Slab Mask Shard
- Bilewater Mask Shard
- Deep Docks Mask Shard
- Shellwood + Vaults Mask Shards
- Blasted Steps Mask Shard
- Cogwork Core Mask Shard
- Wisp Thicket Mask Shard
- Mt. Fay Mask Shard
- Brightvein Mask Shard

`has_obtained_mask_count`
- 1 Extra Mask
- 2 Extra Masks

`has_obtained_spool_fragment`
- Deep Docks Spool Fragments (2)
- Greymoor Spool Fragment
- Frey's Spool Fragment
- Grand Gate Spool Fragment
- High Halls Spool Fragment

`has_obtained_spool_count`
- 1 Spool Upgrade
- 2 Spool Upgrades
- 3 Spool Upgrades
- 