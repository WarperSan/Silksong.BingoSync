...
public static partial class PlayerDataExtensions
{
	...
	/// </summary>
	private static string GetMementoId(Memento memento) => memento switch
	{
	...
	/// </summary>
	private static CollectableMementosData.Data? GetMementoData(this PlayerData data, Memento memento)
	{
